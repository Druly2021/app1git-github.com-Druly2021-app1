...
class Order(models.Model):
    ...
    delivery_addres = models.TextField(null=True, blank=True, verbose_name="Адрес доставки")
    ...
    def __str__(self):
        return f"Заказ № {self.pk} | Покупатель {self.user.first_name} {self.user.lastt_name}"
